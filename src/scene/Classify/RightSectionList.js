    ...
    this.getItemLayout = sectionListGetItemLayout({
      ...
      getItemHeight: (rowData, sectionIndex, rowIndex) => {
        if (
          ...
          rowData.subCategoryList.length > 0
        ) {
          return (
            SINGLE_ITEM_HEIGHT * Math.ceil(rowData.subCategoryList.length / 3) +
            SINGLE_SUBCATEGORY_TITLE
          );
      ...
      >
        ...
        >
          ...
          <Text style={{ fontSize: 15 }}>
            {/* {rowData.section.categoryName + rowData.section.classifyTreeIndex}{' '} */}
            【 {rowData.section.categoryName} 】
          </Text>
        </View>
      </View>
    );
