...
export default {
  mapi: !mapi._global.isprocess
    ? ((mapi._global.isprocess = true),
      console.warn('deepURI from ' + JSON.stringify(mapi._global || {})),
      deepURI(mapi))
    : mapi,
  appapi: !appapi._global.isprocess
    ? ((appapi._global.isprocess = true),
      ...
      deepURI(appapi))
    : appapi,
  xbrapi: !xbrapi._global.isprocess
    ? ((xbrapi._global.isprocess = true),
      console.warn('deepURI from ' + JSON.stringify(xbrapi._global || {})),
      deepURI(xbrapi))
    : xbrapi,
